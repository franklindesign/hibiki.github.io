  ...
  <v-app dark class="appBg">
    ...
    <v-navigation-drawer temporary fixed v-model="drawer" right class="navDrawerBg" app>
      ...
      <v-list subheader dense>
        ...
        <v-list-tile router :to="item.to" v-for="item in items" :key="item.avatar" exact active-class="red--text" class="mb-2">
          <v-list-tile-content>
    ...
    <v-layout row justify-center>
      <v-dialog v-model="dialog" max-width="350px" transition="dialog-transition">
        <v-card light>
          ...
          <v-card-text>Hibiki Sushi & Bar brings a modern family style asian cuisine to Santa Clarita. Located just between Soledad Canyon Rd and Shangri-La Drive. Experience for yourself our expansive menu of over 100 ever-changing items of immaculately prepared sushi,
            ...
            great lighting and music. Our dining area and spacious bar ties the atmosphere together for great parties and celebrations.</v-card-text>
          <v-card-actions>
            <v-spacer></v-spacer>
    ...
    <v-layout row justify-center>
      <v-dialog v-model="openhours" max-width="300px" transition="dialog-transition">
        <v-card light>
          ...
          <v-card-text> Monday: 11:30 am – 10 pm<br> Tuesday: 11:30 am – 10 pm<br> Wednesday: 11:30 am – 10 pm<br> Thursday: 11:30 am – 10 pm<br> Friday: 11:30 am – 11 pm<br> Saturday: 11:30 am – 11 pm<br> Sunday: 11:30 am – 10 pm<br>
          </v-card-text>
          <v-card-actions>
            <v-spacer></v-spacer>
      ...
      <v-dialog v-model="map" max-width="350px" transition="dialog-transition">
        <v-card light>
          ...
          <v-card-text><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d210850.9797048854!2d-118.61322625357718!3d34.336565484979076!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c288f3845298d9%3A0xc716780c1867000a!2s27625+Shangri+La+Dr%2C+27625+Shangri-La+Dr%2C+Santa+Clarita%2C+CA+91351!5e0!3m2!1sen!2sus!4v1521311510190"
              width="320" height="400" frameborder="0" style="border:0" allowfullscreen></iframe></v-card-text>
          <v-card-actions>
            <v-spacer></v-spacer>
